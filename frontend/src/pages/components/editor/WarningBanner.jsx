 ...
 * Shows yellow banner with save button
 */
const WarningBanner = ({ onSave }) => {
  return (
    <div className="bg-yellow-50 border-b border-yellow-200 px-4 py-2.5 flex items-center justify-between text-sm flex-shrink-0">
